...
<form id="uploadForm" enctype="multipart/form-data">
    ...
        <br><br><br>
        <button id="upload" type="button"  onclick="uploadImg()" >上传图片到阿里云</button>
...
<script>
    ...
    function upp(obj) {
        ...
        var picturee=$("#pict").val();
        var idd=$("#idd").val();
        alert(idd)
        $.ajax({
            type : "post",
            url : "${ctx}/upLoad/uploadCompany",
            data : {
                'picture' : picturee,
                'id' : idd,
                'data':obj
...
<div style="float: left;">
           
        </div>
            <input type="hidden" id="pict" value="${picture}"/>
