        ...
        <form method="post" id="registerForm" action="${ctx}/login/register">
            <div class="zhuce_wid">
                ...
                <div class="f-cb zhuce_tt">
                    ...
                    <input id="phone1" type="text" placeholder="请输入已绑定的手机号"/>
                </div>
                ...
                <div class="f-cb zhuce_tt">
                    <span>手机验证码:</span>
                    <div class="code1">
                        <input id="code1" type="text" name="code1" placeholder="短信验证码"/>
                        <input id="btnSendCode1" type="button" class="btn btn-default" value="获取验证码"
                               onClick="sendMessage1()"/>
                    </div>

                    <div class="f-cb zhuce_tt">
                        <input id="tips" type="button" class="btn btn-default" value="确定"
                               onclick="binding()"/>
                    </div>
                    ...
                    <div class="f-cb zhuce_tt">
                        <span>固定电话:</span>
                        <input type="text" placeholder="区号1" class="mar6" style="width:50px;" name="zone1"
                               id="zone1"><input type="text" placeholder="座机号1" class="mar6" style="width:150px;"
                                                 name="tel1" id="tel1"> <input type="text" placeholder="区号2"
                                                                               class="mar6" style="width:50px;"
                                                                               name="zone2" id="zone2"><input
...
<script type="text/javascript">
    ...
    function getProtocol() {
        ...
        ${ctx}/loginAction.do?method=getProtocol", {
		title : "法律声明",
		width :1024,
		height : 720,
		buttons : { /*'关闭': true}
